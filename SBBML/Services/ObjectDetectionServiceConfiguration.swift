...
public struct ObjectDetectionServiceConfiguration: Equatable {
    ...
    /**
     ...
     - Parameters:
        ...
        - objectDetectionRate: The minimum TimeInterval in seconds between two ObjectDetection requests. Bounding boxes of detected objects can be updated using object tracking between ObjectDetectionrequests, so th